...
const HIGHLIGHTS = [
  { icon: '⚡', label: 'Electronics Engineering student at Bahrain Polytechnic University (2023–2027)' },
  { icon: '💻', label: 'Full Stack bootcamp graduate, General Assembly (2025)' },
  { icon: '🏆', label: 'Won Tamkeen Tech Startup pitch competition at Wyndham Grand Hotel' },
  { icon: '🚀', label: 'Built & deployed complete ERP system as Junior Dev at Leading Trading Est' },
];
      ...
      <div className="container about__inner">
        ...
        <div className="about__card">
          ...
          <div className="about__socials">
            <a href="https://www.linkedin.com/in/muhammad-hassan-3b5b5a349/" target="_blank" rel="noreferrer" className="about__social-btn">
              LinkedIn
            </a>
            <a href="mailto:hasnshahidd@gmail.com" className="about__social-btn">
              Email
            </a>
          </div>
        </div>
